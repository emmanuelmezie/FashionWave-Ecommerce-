$(document).ready(function(){
	...
	//featuredproduct() is a funtion fetching featured product record from database whenever page is load
		function featuredproduct(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
			data	:	{getFeaturedProduct:1},
			success	:	function(data){
				$("#get_featured_product").html(data);
			}
		})
	}
